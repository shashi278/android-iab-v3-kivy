...
source.include_exts = py,png,java
...
icon.filename = %(source.dir)s/buy.png
...
# e.g. android.gradle_repositories = "maven { url 'https://maven.google.com' }"
...
# android.add_gradle_repositories = 'com.google.android.play:core:jar:1.10.0'
...
android.logcat_filters = *:S python:D # | grep 'PlayCore\|Python\|python' 
